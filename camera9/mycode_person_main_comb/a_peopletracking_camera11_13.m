function [R_main, R_com_info, R_other, im] = a_peopletracking_camera11_13(im_r,R_main, R_people_var, R_com_info, R_c9,...
    camera_no, R_other)
%% region 1 extraction
global scale;
    ...
    for i = 1:size(R_main.people_array,2)
        ...
        if camera_no == 13
            ...
            if R_main.people_array{i}.Centroid(2) < R_people_var.init_limit_exit_y1 - 10 %&& R_people_var.people_array{i}.Centroid(1) < R_main.init_limit_exit_x1
                ...
                R_com_info.check_13 = max(R_com_info.check_13 - 1, 0);
                ...
                R_other.people_array{end}.BoundingBox(2) = 550;
        ...
        if ( R_main.people_array{i}.Centroid(2) > limit_exit_y1 && R_main.people_array{i}.Centroid(1) > limit_exit_x1 ) || ...
            ...
            if camera_no == 11
                R_com_info.check_13 = R_com_info.check_13 + 1;
                %R_com_info.check_11 = 0;
                R_com_info.id = R_main.people_array{i}.id;
                R_com_info.label = R_main.people_array{i}.label;
                R_other.people_array{end+1} = R_main.people_array{i};
                R_other.people_array{end}.Centroid(2) = 150;
                R_other.people_array{end}.BoundingBox(2) = 20;
                half_y = 473;
            else
                % camera 13, exit from scene
                R_com_info.check_13 = R_com_info.check_13 - 1;
...
%         end
        ...
        if R_main.people_array{i}.Centroid(1) > critical_exit_x && R_main.people_array{i}.Centroid(2) > critical_exit_y
            ...
            if (R_main.people_array{i}.critical_del) == -1000
                ...
                if R_main.people_array{i}.Centroid(2) > R_main.people_array{i}.prev_centroid
...
im = displayimage11_13_people(im_actual, R_main.people_array, camera_no);
