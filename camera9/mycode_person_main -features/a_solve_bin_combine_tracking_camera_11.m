...
for file_number_str = all_file_nums
    ...
    while hasFrame(v_11) && v_11.CurrentTime < ( end_f / v_11.FrameRate )
        ...
        im_r = im_c(R_11.R_people.r1(3):(R_11.R_people.r1(4)),R_11.R_people.r1(1):R_11.R_people.r1(2),:);
        R_people_var = [];
        ...
        if associate_13 && R_com_info.check_13 ~=0  
            ...
            im_r = im_c(R_13.R_people.r1(3):(R_13.R_people.r1(4)),R_13.R_people.r1(1):R_13.R_people.r1(2),:);
            R_people_var = [];
            R_people_var.thres_low = 0.4;
            R_people_var.thres_up = 1.5;
            R_people_var.min_allowed_dis = 200 * scale;
