...
setup_paths();
base_path  = '../../all_videos/6A/11';
seq.scale= 0.5;
seq.k_distort_11 = 0;% -0.24;
seq.rot_angle = 90;%102;
seq.r4 = [230 550 150-140 1920] * seq.scale ; % camera 11
%seq.r4 = [660 990 536 1676] * seq.scale ; % camera 9

%seq.r4 = [996 1396 512 2073] * seq.scale; % people
