function [R1,people_seq] = a_peopletracking2(im2_b,R1,people_seq)
% R1 structure
r1_obj = R1.r1_obj;
r1_cnt = R1.r1_cnt;
r1_lb = R1.r1_lb;
...
if (pcnt_r1 ~= 0)
    ...
    if (r1_cnt ~= 0)
        ...
        for i = 1:r1_cnt
            true_y=R1.r1(3)+r1_obj(i,2);
            true_x=R1.r1(1)+r1_obj(i,1);
        ...
        for i = 1:pcnt_r1
            if (temp_r1(i,4)==0)
                true_y=R1.r1(3)+temp_r1(i,2);
                true_x=R1.r1(1)+temp_r1(i,1);
