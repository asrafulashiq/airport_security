...
matfile_save = matfile(file_to_save, 'Writable', true);
matfile_save.r1_obj = [];
matfile_save.r1_cnt = [];
matfile_save.r1_lb = [];
...
while hasFrame(v) && v.CurrentTime < ( end_f / v.FrameRate )
    ...
    matfile_save.r1_obj = [matfile_save.r1_obj R_dropping.r1_obj ];
    matfile_save.r1_cnt = [matfile_save.r1_cnt R_dropping.r1_cnt];
    matfile_save.r1_lb = [matfile_save.r1_lb R_dropping.r1_lb];
