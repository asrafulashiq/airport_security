...
%     % search intermediate empty space for new bin
%     i = 1;
%     for counter = 1:size(bin_array, 2)
%         loc_up = bin_array{i}.limit(2);
%         if i==1
%             loc_down = size(I,1)*.6;
%         else
%             loc_down = bin_array{i-1}.limit(1);
%         end
%         
%         if loc_down - loc_up > thr * length(r_tall_bin)
%             
%             loc_empty = [loc_up loc_down];
%             bins = match_template_signal(I, {}, loc_empty);
%             if isempty(bins)
%                 i = i + 1;
%                 continue;               
%             end
...
%                 part1 = {};
%             else
%                 part1 = {bin_array{1:i-1}};
%             end
%             
%             bin_array = {part1{:} bins{:} bin_array{i:end}};
%             
%             i = i + 2;
%             
%         end
